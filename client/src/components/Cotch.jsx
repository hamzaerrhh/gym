const Cotch = () => {
  return (
    <section className="py-6 bg-black-100 text-gray-800">
        ...
        <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
          <div className="flex space-x-6">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-sm dark:text-gray-600">Mma cotch</p>
          ...
          <div className="flex space-x-6">
            ...
            <div className="flex flex-col">
              <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
              <p className="text-sm dark:text-gray-600">swiming cotch</p>
              <div className="flex mt-2 space-x-2">
                <a
                  rel="noopener noreferrer"
                  href="#"
          ...
          <div className="flex space-x-6">
            ...
            <div className="flex flex-col">
              <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
              <p className="text-sm dark:text-gray-600">dance cotch</p>
              <div className="flex mt-2 space-x-2">
                <a
                  rel="noopener noreferrer"
                  href="#"
          ...
          <div className="flex space-x-6">
            ...
            <div className="flex flex-col">
              <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
              <p className="text-sm dark:text-gray-600">taekwando cotch</p>
              <div className="flex mt-2 space-x-2">
                <a
                  rel="noopener noreferrer"
                  href="#"
